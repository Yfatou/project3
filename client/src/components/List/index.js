...
export function ListItem({ 
  ...
  return <li className="list-group-item" data-id={key}>{" Title: "  + title } <br/> {"Zip: "+  zip}  <br/> {"Date: "+ date} <br/>{"Time: "+time }{"Notes: "+notes} <br/>  {<button className="btn btn-primary" > Available? </button>}<br/></li>;
